from interfaces.mongodb_requests import mongo_add_gateway, mongo_add_gateway_job, mongo_update_gateway_namespace
...
def _prepare_gateway_job_dict(gateway_info):
    """
        ...
        table queries by NetManagers resolve to the gateway
