from interfaces.mongodb_requests import mongo_add_gateway, mongo_add_gateway_job, mongo_get_service_ips_by_jobname
from interfaces.root_service_manager_requests import system_manager_notify_gateway_deployment
from interfaces.mqtt_client import mqtt_publish_gateway_deploy, mqtt_publish_gateway_firewall_expose
...
def update_gateway(gateway_id, service_info):
    ...
    service_ips = mongo_get_service_ips_by_jobname(service_info['job_name'])['service_ip_list']
    print(service_ips)
